...
public class ChartUtils {
    ...
    public static LineChart initChart(LineChart chart) {
        ...
        xAxis.setGridColor(Color.parseColor("#c8cccc"));
        // 设置x轴数据偏移量
        xAxis.setYOffset(-12);
     ...
     * @param yValues 数据
     */
    public static void setChartData(LineChart chart, List<Entry> yValues) {
        ...
        if (chart.getData() != null && chart.getData().getDataSetCount() > 0) {
            ...
            // 设置曲线颜色
            lineDataSet.setColor(Color.parseColor("#ffba14"));
            // 设置平滑曲线
            lineDataSet.setMode(LineDataSet.Mode.CUBIC_BEZIER);
            lineDataSet.setCircleColor(Color.parseColor("#ffba14"));
